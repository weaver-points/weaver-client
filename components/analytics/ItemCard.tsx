            ...
            <div className="absolute top-0 left-0 w-full h-full flex flex-col items-start gap-0 " >
                <div className="w-full h-full bg-[#1E1E1E] " >
                    <div className=" h-[64%] w-full flex items-center justify-center relative" >
                        ...
                        <span className=" absolute z-10 top-5 right-5 flex items-center gap-1 bg-[#444444] rounded-[29px] px-3 py-1 "  > <BiUser size={20} /> {data.participantCount} </span>
                    ...
                    <div className="px-6 py-6 flex  items-center justify-between gap-10 h-[36%] " >
                        ...
                        <div className="flex flex-col items-start gap-1" >
                            <h3 className="text-lg font-medium text-white  " > {formatDate(data.startTime)} </h3>
                            <p className="text-[#988C8C] text-sm font-medium " >to {formatDate(data.endTime)} </p>
