...
import { Twitter, MoreHorizontal, Plus } from "lucide-react";
                    ...
                    <div className="w-full basis-1/2 max-w-[520px] flex flex-col gap-5">
                        ...
                        <div className="flex w-fit items-center gap-2">
                            {projectTags.map((tag, index) => (
                                <span key={index} className="rounded-[4px] bg-muted py-1 px-2 text-base font-normal text-foreground">
                                    {tag}
                                </span>
                            ))}
                        </div>

                        <p className="text-lg font-normal text-muted-foreground">{projectDescription}</p>
                    ...
                    <div className="basis-1/2 max-w-[520px] flex items-start flex-col-reverse md:flex-row justify-center gap-6">
                        ...
                        <div className="bg-card flex items-center justify-center rounded-[10px] gap-6 py-4 px-5 border border-border">
                            <div className="flex flex-col items-start gap-1">
                                <small className="font-normal text-muted-foreground text-sm md:text-base">Followers</small>
                                <p className="text-foreground font-bold text-lg md:text-[22px]">8,674</p>
                            </div>

                            <div className="w-[1px] h-10 bg-border mx-4"></div>
                            <div className="flex flex-col items-start gap-1">
                                <small className="font-normal text-muted-foreground text-sm md:text-base">Token</small>
